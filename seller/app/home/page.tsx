    ...
    <div className="w-full h-screen flex justify-center items-center bg-[#ffffff]">
      <div className="flex flex-col items-center gap-5 w-full max-w-[360px]">
        ...
        <div className="p-2 w-full flex items-center">
          ...
          <p className="ml-2 text-s font-bold text-[#22583F]">Jay's Sari Sari Store</p>
        </div>
        ...
        <div className="rounded-lg text-left p-4 mb-3 bg-[#ECEFE4] w-full">
          ...
          <p className="text-6xl font-semibold text-[#645856] mt-1">100,000.00</p>
        </div>
          ...
          {transactions.map((transaction, index) => (
            ...
            >
              <div className="flex flex-col">
                <span className="text-xs text-[#645856]">Total points sent to</span>
                <span className="text-xl text-[#645856] font-medium">{transaction.name}</span>
              </div>
              <div className="flex flex-col items-end">
                <span className="text-xs text-[#645856]">{transaction.date}</span>
                <span className="text-xl font-bold text-[#645856]">{transaction.points}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="flex mt-0.5 w-full justify-center items-center p-2">
          <button className="px-4 py-2 rounded-lg bg-white border border-gray-300">&lt;</button>
          <div className="flex space-x-2 mx-1">
            <button className="px-4 py-2 rounded-lg bg-white border border-gray-300">1</button>
            <button className="px-4 py-2 rounded-lg bg-[#C2E96A] text-[#22583F]">2</button>
            <button className="px-4 py-2 rounded-lg bg-white border border-gray-300">...</button>
            <button className="px-4 py-2 rounded-lg bg-white border border-gray-300">9</button>
            <button className="px-4 py-2 rounded-lg bg-white border border-gray-300">10</button>
          </div>
          <button className="px-4 py-2 rounded-lg bg-white border border-gray-300">&gt;</button>
        </div>
